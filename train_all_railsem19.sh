...
CONFIGS=(
    "configs/mask2former/mask2former_swin-l-in22k-384x384-pre_8xb2-160k_railsem19-512x1024.py"
    "configs/segformer/segformer_mit-b5_8xb1-160k_railsem19-512x1024.py"
    ...
    "configs/unet/unet-s5-d16_fcn_1xb8-80k_railsem19-512x1024.py"
)
