...
experiment_name = 'mapillary_to_railsem19'
img_ratios = [
    0.5,
    0.75,
    1.0,
...
launcher = 'none'
load_from = 'work_dirs/domain_adaptation/experiment1_mapillary_to_railsem19/iter_160000.pth'
log_level = 'INFO'
...
work_dir = 'work_dirs/domain_adaptation/experiment1_mapillary_to_railsem19/test_results'
