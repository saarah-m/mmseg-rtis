...
launcher = 'none'
load_from = 'work_dirs/domain_adaptation/experiment2_cityscapes_to_railsem19/iter_160000.pth'
log_level = 'INFO'
...
work_dir = 'work_dirs/domain_adaptation/experiment2_cityscapes_to_railsem19/test_results'
