#!/usr/bin/env python3
"""
Training script for Experiment 2: Mapillary → RailSem19
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        default="configs/domain_adaptation/experiment2_mapillary_to_railsem19.py",
        help="config file path",
    )
    parser.add_argument(
        "--work-dir",
        default="work_dirs/domain_adaptation/experiment2_mapillary_to_railsem19",
