#!/usr/bin/env python3
"""
Training script for Experiment 1: CityScapes → RailSem19
...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        default="configs/domain_adaptation/experiment1_cityscapes_to_railsem19.py",
        help="config file path",
    )
    parser.add_argument(
        "--work-dir",
        default="work_dirs/domain_adaptation/experiment1_cityscapes_to_railsem19",
...
def main():
    ...
    print(f"\n{'='*80}")
    print(f"🚀 STARTING EXPERIMENT 1: CityScapes → RailSem19")
    print(f"{'='*80}")
