#!/usr/bin/env python3
"""
Training script for Experiment 1: Mapillary → RailSem19
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Mapillary → RailSem19")
    parser.add_argument(
        "--config",
        default="configs/domain_adaptation/experiment1_mapillary_to_railsem19.py",
        help="config file path",
    )
    parser.add_argument(
        "--work-dir",
        default="work_dirs/domain_adaptation/experiment1_mapillary_to_railsem19",
