...
class RTISRailDataset(BaseSegDataset):
    """RTIS-Rail-2022v7 dataset with 19 classes and color palette from class_to_id_USE_THIS.json."""

    # Path to the dataset root
    data_root = "data/rtis-rail-2022v7/"
    cfg_path = osp.join(data_root, "class_to_id_USE_THIS.json")
