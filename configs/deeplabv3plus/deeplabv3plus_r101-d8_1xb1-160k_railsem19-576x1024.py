...
# Use BN for backbone, GN for decode_head (ASPP has 1x1 pooling - BN fails with batch_size=1)
norm_cfg = dict(type='BN', requires_grad=True)
norm_cfg_decode = dict(type='GN', num_groups=8, requires_grad=True)  # 8 divides 48, 256, 512
model = dict(
