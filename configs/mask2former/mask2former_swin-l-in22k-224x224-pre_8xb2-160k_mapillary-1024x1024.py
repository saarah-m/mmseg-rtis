_base_ = ['../_base_/default_runtime.py', '../_base_/datasets/mapillary_v1.py']

# Mask2Former with Swin-L backbone - Training from scratch on Mapillary
# This config trains Mask2Former with Swin-L (ImageNet-22k pretrained) on Mapillary v1.2
# Optimized for best performance with AMP, warmup scheduler, and improved augmentation
