...
# Experiment 2 - Stage 2: Cityscapes → RailSem19
# This configuration fine-tunes a model pre-trained on Cityscapes to RailSem19.
# 
# PREREQUISITE: First run experiment2_stage1_cityscapes.py to train on Cityscapes.
# Then update the checkpoint path below to point to the best checkpoint from stage 1.
# Example: "work_dirs/experiment2_stage1_cityscapes/best_mIoU_iter_XXXXX.pth"

crop_size = (1024, 1024)
data_preprocessor = dict(size=crop_size)

# Load pretrained weights from Cityscapes (Stage 1)
# TODO: Update this path after running experiment2_stage1_cityscapes.py
checkpoint = "work_dirs/experiment2_stage1_cityscapes/best_mIoU_iter_XXXXX.pth"
...
# Experiment metadata
experiment_name = "experiment2_stage2_railsem19"
